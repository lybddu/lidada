...
import com.llyb.lidada.annotation.AuthCheck;
import com.llyb.lidada.common.BaseResponse;
import com.llyb.lidada.common.DeleteRequest;
import com.llyb.lidada.common.ErrorCode;
import com.llyb.lidada.common.ResultUtils;
import com.llyb.lidada.constant.UserConstant;
import com.llyb.lidada.exception.BusinessException;
import com.llyb.lidada.exception.ThrowUtils;
import com.llyb.lidada.manager.AiManager;
import com.llyb.lidada.model.dto.question.*;
import com.llyb.lidada.model.entity.App;
import com.llyb.lidada.model.entity.Question;
import com.llyb.lidada.model.entity.User;
import com.llyb.lidada.model.enums.AppTypeEnum;
import com.llyb.lidada.model.vo.QuestionVO;
import com.llyb.lidada.service.AppService;
import com.llyb.lidada.service.QuestionService;
import com.llyb.lidada.service.UserService;
...
public class QuestionController {
    ...
    public BaseResponse<List<QuestionContentDTO>> aiGenerateQuestion(
        ...
        // AI 生成
        String result1 = aiManager.doSyncRequest(GENERATE_QUESTION_SYSTEM_MESSAGE, userMessage, null);
        JSONObject res =(JSONObject) JSONUtil.parse(result1);
        String result = res.getJSONObject("message").getStr("content");
        // 截取需要的 JSON 信息
